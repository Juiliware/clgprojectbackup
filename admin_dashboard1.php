...
<body class="font-sans antialiased bg-gray-100 min-h-screen">
    <div class="flex">
        ...
        <aside class="w-64 bg-gray-800 text-white min-h-screen p-4 transition-transform transform sidebar">
            ...
            <ul class="space-y-4">
                           <li onclick="showSection('dashboard')" class="flex items-center hover:bg-gray-700 p-3 rounded cursor-pointer transition duration-300 ease-in-out active:bg-gray-600" id="dashboard-link">
    ...
    <section id="dashboard" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-6 hidden">
        <div class="bg-gradient-to-r from-blue-400 to-blue-600 p-6 rounded-lg shadow-lg flex items-center transform transition duration-500 hover:scale-105 hover:shadow-xl h-40">
            <div class="flex justify-center items-center w-1/4">
                <i class="fas fa-book text-white text-4xl"></i> <!-- Increased icon size -->
            </div>
            <div class="w-3/4 text-left">
                <h3 class="text-2xl font-bold text-white">12</h3> <!-- Increased text size -->
        ...
        <div class="bg-gradient-to-r from-green-400 to-green-600 p-6 rounded-lg shadow-lg flex items-center transform transition duration-500 hover:scale-105 hover:shadow-xl h-40">
            <div class="flex justify-center items-center w-1/4">
                <i class="fas fa-users text-white text-4xl"></i> <!-- Increased icon size -->
            </div>
            <div class="w-3/4 text-left">
                <h3 class="text-2xl font-bold text-white">5</h3> <!-- Increased text size -->
        ...
        <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 p-6 rounded-lg shadow-lg flex items-center transform transition duration-500 hover:scale-105 hover:shadow-xl h-40">
            <div class="flex justify-center items-center w-1/4">
                <i class="fas fa-clock text-white text-4xl"></i> <!-- Increased icon size -->
            </div>
            <div class="w-3/4 text-left">
                <h3 class="text-2xl font-bold text-white">1</h3> <!-- Increased text size -->
        ...
        <div class="bg-gradient-to-r from-purple-400 to-purple-600 p-6 rounded-lg shadow-lg flex items-center transform transition duration-500 hover:scale-105 hover:shadow-xl h-40">
            <div class="flex justify-center items-center w-1/4">
                <i class="fas fa-user-check text-white text-4xl"></i> <!-- Increased icon size -->
            </div>
            <div class="w-3/4 text-left">
                <h3 class="text-2xl font-bold text-white">3</h3> <!-- Increased text size -->
        ...
        <div class="bg-gradient-to-r from-red-400 to-red-600 p-6 rounded-lg shadow-lg flex items-center transform transition duration-500 hover:scale-105 hover:shadow-xl h-40">
            <div class="flex justify-center items-center w-1/4">
                <i class="fas fa-user-times text-white text-4xl"></i> <!-- Increased icon size -->
            </div>
            <div class="w-3/4 text-left">
                <h3 class="text-2xl font-bold text-white">7</h3> <!-- Increased text size -->
        ...
        <div class="bg-gradient-to-r from-pink-400 to-purple-600 p-6 rounded-lg shadow-lg flex items-center transform transition duration-500 hover:scale-105 hover:shadow-xl h-40">
            <div class="flex justify-center items-center w-1/4">
                <i class="fas fa-question-circle text-white text-4xl"></i> <!-- Increased icon size -->
            </div>
            <div class="w-3/4 text-left">
                <h3 class="text-2xl font-bold text-white">5</h3> <!-- Increased text size -->
...
<section id="registeredUsers" class="p-6 bg-white rounded-lg shadow-lg mt-6 mx-4">
    ...
    <div class="relative overflow-x-auto">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-md text-left text-gray-500 dark:text-gray-400 border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-150">
                        ...
                        <td class="px-4 py-3 space-x-2">
                            ...
                            <a href="?action=view&id=<?php echo htmlspecialchars($user['id']); ?>" class="text-green-600 hover:underline" title="View Application">
                                View Application
                            </a>
                        </td>
                    </tr>
