...
<div id="applicationEditFormContent" class="content-section hidden">
    ...
    <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition mt-6">
        <form id="applicationEditForm" class="space-y-8 mt-8" action="submit_edit_application.php" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="students_id" value="<?php echo htmlspecialchars($existing_data['students_id']); ?>">
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        <label for="name" class="block text-gray-700 font-medium">Full Name</label>
                        <input type="text" id="name" name="name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo htmlspecialchars($existing_data['name']); ?>" required>
                    </div>
                    <div class="space-y-1">
                        <label for="course_applied" class="block text-gray-700 font-medium">Course Applied</label>
                        <select id="course_applied" name="course_applied" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                            <option value="Science" <?php echo ($existing_data['course_applied'] == 'Science') ? 'selected' : ''; ?>>Science</option>
                            <option value="Commerce" <?php echo ($existing_data['course_applied'] == 'Commerce') ? 'selected' : ''; ?>>Commerce</option>
                            <option value="Arts" <?php echo ($existing_data['course_applied'] == 'Arts') ? 'selected' : ''; ?>>Arts</option>
                        </select>
                    </div>
                    <div class="space-y-1">
                        <label for="dob" class="block text-gray-700 font-medium">Date of Birth</label>
                        <input type="date" id="dob" name="dob" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo htmlspecialchars($existing_data['dob']); ?>" required>
                    </div>
                    <div class="space-y-1">
                        <label for="gender" class="block text-gray-700 font-medium">Gender</label>
                        <select id="gender" name="gender" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                            ...
                            <option value="Other" <?php echo ($existing_data['gender'] == 'Other') ? 'selected' : ''; ?>>Other</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        <label for="fatherName" class="block text-gray-700 font-medium">Father's Name</label>
                        <input type="text" id="fatherName" name="fatherName" class ="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo htmlspecialchars($existing_data['father_name']); ?>" required>
                    </div>
                    <div class="space-y-1">
                        <label for="motherName" class="block text-gray-700 font-medium">Mother's Name</label>
                        <input type="text" id="motherName" name="motherName" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo htmlspecialchars($existing_data['mother_name']); ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="space-y-1">
                    <label for="address" class="block text-gray-700 font-medium">Permanent Address</label>
                    <input type="text" id="address" name="address" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo htmlspecialchars($existing_data['address']); ?>" required>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        <label for="caste" class="block text-gray-700 font-medium">Caste</label>
                        <input type="text" id="caste" name="caste" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo htmlspecialchars($existing_data['caste']); ?>" required>
                    </div>
                    <div class="space-y-1">
                        <label for="income" class="block text-gray-700 font-medium">Annual Family Income</label>
                        <input type="number" id="income" name="income" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo htmlspecialchars($existing_data['income']); ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-1">
                <label for="previousCollege" class="block text-gray-700 font-medium">Previous College</label>
                <input type="text" id="previousCollege" name="previousCollege" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo htmlspecialchars($existing_data['previous_college']); ?>">
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        ...
                        <small class="text-gray-500">Current: <?php echo htmlspecialchars($existing_data['aadhar']); ?></small>
                    </div>
                    <div class="space-y-1">
                        <label for="lc" class="block text-gray-700">Leaving Certificate (LC)</label>
                        ...
                        <small class="text-gray-500"> Current: <?php echo htmlspecialchars($existing_data['lc']); ?></small>
                    </div>
                    <div class="space-y-1">
                        <label for="markSheet" class="block text-gray-700">Board Exam Mark Sheet</label>
                        ...
                        <small class="text-gray-500">Current: <?php echo htmlspecialchars($existing_data['marksheet']); ?></small>
                    </div>
                    <div class="space-y-1">
                        <label for="incomeCert" class="block text-gray-700">Income Certificate</label>
                        ...
                        <small class="text-gray-500">Current: <?php echo htmlspecialchars($existing_data['income_cert']); ?></small>
                    </div>
                    <div class="space-y-1">
                        <label for="casteCert" class="block text-gray-700">Caste Certificate</label>
                        ...
                        <small class="text-gray-500">Current: <?php echo htmlspecialchars($existing_data['caste_cert']); ?></small>
                    </div>
                </div>
            </div>
